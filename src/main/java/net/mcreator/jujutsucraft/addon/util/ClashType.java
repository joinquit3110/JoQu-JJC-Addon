...
public enum ClashType {
    ...
    /** Open domain erodes a closed domain's barrier. */
    OPEN_VS_CLOSED("Open vs Closed"),

    /** Two open domains engage in mutual sure-hit erosion. */
    OPEN_VS_OPEN("Open vs Open"),

    /** Open domain erodes while incomplete domain wraps — hybrid pressure. */
    OPEN_VS_INCOMPLETE("Open vs Incomplete"),

    /** Two closed domains apply mutual barrier pressure. */
    CLOSED_VS_CLOSED("Closed vs Closed"),

    /** Closed domain receives wrap pressure from an incomplete domain. */
    CLOSED_VS_INCOMPLETE("Closed vs Incomplete"),

    /** Two incomplete domains apply mutual wrap pressure. */
