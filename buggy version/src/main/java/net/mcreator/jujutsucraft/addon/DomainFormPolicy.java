...
public final class DomainFormPolicy {
    ...
    public static Policy policyOf(double rawDomainId) {
        ...
        return new Policy(Archetype.SPECIAL, true, 0.01, 12.0, 0.9, 1.1, 1.0, 0.5);
    }

    /**
     * Central hazardous-effect policy. Incomplete suppresses hazardous effects by default;
     * explicit opt-outs should only be added here after domain-specific review.
     */
    public static boolean shouldSuppressHazardousEffect(double rawDomainId, int formId, HazardType hazardType) {
        if (formId == 0) {
            return true;
        }
        return false;
    ...
    static {
        ...
        DomainFormPolicy.put(27, Archetype.CONTROL, true, 0.01, 12.0, 0.85, 1.1, 1.0, 0.65);
        DomainFormPolicy.put(24, Archetype.CONTROL, true, 0.01, 12.5, 0.9, 1.1, 1.0, 0.6);
        DomainFormPolicy.put(36, Archetype.CONTROL, true, 0.012, 12.5, 0.9, 1.1, 1.0, 0.6);
        DomainFormPolicy.put(6, Archetype.SUMMON, true, 0.02, 13.0, 0.85, 1.05, 1.05, 0.3);
        DomainFormPolicy.put(21, Archetype.SUMMON, true, 0.02, 13.0, 0.85, 1.05, 1.05, 0.3);
        DomainFormPolicy.put(23, Archetype.SUMMON, true, 0.018, 13.5, 0.88, 1.08, 1.05, 0.35);
        DomainFormPolicy.put(35, Archetype.SUMMON, true, 0.016, 13.0, 0.88, 1.08, 1.05, 0.35);
        ...
        DomainFormPolicy.put(40, Archetype.AOE, true, 0.012, 13.5, 0.92, 1.15, 0.98, 0.55);
        DomainFormPolicy.put(7, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(9, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(11, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(13, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(14, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(19, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(20, Archetype.UTILITY, true, 0.02, 13.0, 0.9, 1.08, 1.05, 0.4);
        DomainFormPolicy.put(25, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(26, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        DomainFormPolicy.put(43, Archetype.UTILITY, true, 0.011, 13.0, 0.95, 1.1, 1.0, 0.5);
        for (int id = 1; id <= 50; ++id) {
            POLICIES.putIfAbsent(id, new Policy(Archetype.SPECIAL, true, 0.01, 12.0, 0.9, 1.1, 1.0, 0.5));
        }
    }
    ...
    /** Hazard categories that can be centrally suppressed for unsafe forms. */
    public static enum HazardType {
        SURE_HIT,
        CHARACTER_EFFECT,
        NEUTRALIZATION,
        DOMAIN_SPECIFIC_REPLAY,
        SUMMON_OR_ENVIRONMENTAL;
    }
