...
public final class ClashSession {
    ...
    private double pressureThisTickA;
    private double pressureThisTickB;
    ...
    public double getPressureThisTickA() { return pressureThisTickA; }
    public double getPressureThisTickB() { return pressureThisTickB; }
    ...
    public boolean isPhysicalResolved() { return physicalResolved; }
    ...
    public void setPressureThisTickA(double v) { this.pressureThisTickA = v; }
    public void setPressureThisTickB(double v) { this.pressureThisTickB = v; }
    public void addPressureTo(UUID uuid, double delta) {
        if (participantA.equals(uuid)) {
            accumulatedPressureA += delta;
            pressureThisTickA += delta;
        } else if (participantB.equals(uuid)) {
            accumulatedPressureB += delta;
            pressureThisTickB += delta;
        }
    }
    public void setLastActiveTick(long tick) { this.lastActiveTick = tick; }
    public void setPhysicalResolved(boolean physicalResolved) { this.physicalResolved = physicalResolved; }
